...
assert.match(src, /<image className="twilightImage" href=\{href\} x=\{padL\} y=\{padT\} width=\{plotW\} height=\{plotH\}/, 'twilight image is aligned to the same map viewport rectangle used by other geolayers and export');
